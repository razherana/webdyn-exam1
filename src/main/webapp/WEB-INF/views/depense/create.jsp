    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex align-items-center">
                <a href="<%= request.getContextPath() %>/list.depense" class="btn btn-dark btn-toggle-filter">
                    <i class="fas fa-list me-2"></i> Liste des Depenses
                </a>
            </div>
        </div>
        ...
        <form method="post" class="col-md-9 mx-auto border rounded px-4 py-4">
            ...
            <div class="mb-3">
                ...
                <input
                    ...
                    placeholder="Achat de 5kg de Riz, ..."
                    required
                />
                <small id="libelleHelpId" class="form-text text-muted"
                    >Libelle de la depense</small
                >
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input
                    ...
                    required
                />
                <small id="dateHelpId" class="form-text text-muted"
                    >Date de la depense</small
                >
            </div>
